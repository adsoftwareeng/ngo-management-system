					...
					<div class="col-sm-8 col-md-8">
						...
						<div class="img-date">
							<div class="meta-date">
								...
								<div class="month">{{date('m,Y',strtotime($events->event_date))}}</div>
							</div>
							<img src="{{asset('public/uploads/event/'.$events->image)}}" alt="" class="img-fluid eventImg">
						</div>
                   	...
                   	<div class="col-sm-4 col-md-4 {{ ($events->is_registration == 1) ? '' : 'd-none'}}">
						<div class="promo-ads" data-background="{{asset('public/uploads/banner-ads.jpg')}}">
