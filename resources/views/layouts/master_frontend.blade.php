...
<head>
    ...
    @endphp
  <!------- SEO Content --------->
    <title>{{ $seo ? $seo->page_title : $page_title }}</title>
    @if(!empty($seo))
    <meta name="description" content="{{ $seo ? $seo->description : generalSetting()->site_name.' Description' }}">
    <meta name="keywords" content="{{ $seo ? $seo->keywords : generalSetting()->site_name.' Keywords' }}">
    <meta name="author" content="{{ $seo ? $seo->author : generalSetting()->site_name }}">
    <link rel="dns-prefetch" href="{{ $seo ? $seo->dns_prefetch : '' }}">
    <link rel="preconnect" href="{{ $seo ? $seo->preconnect : '' }}">
    <link rel="canonical" href="{{ $seo ? $seo->canonical : url()->current() }}">
    
    <!-- Open Graph Data -->
    <meta property="og:title" content="{{ $seo ? $seo->og_title : $page_title }}">
    <meta property="og:image" content="{{ $seo ? asset('public/uploads/seo/'.$seo->og_image) : '' }}">
    <meta property="og:image:width" content="{{ $seo ? $seo->og_image_width : '' }}">
    <meta property="og:image:height" content="{{ $seo ? $seo->og_image_height : '' }}">
    <meta property="og:description" content="{{ $seo ? $seo->og_description : $page_title }}">
    <meta property="og:url" content="{{ $seo ? $seo->og_url : url()->current() }}">
    <meta property="og:site_name" content="{{ $seo ? $seo->og_site_name : generalSetting()->site_name }}">
    <meta property="og:type" content="{{ $seo ? $seo->type : generalSetting()->site_name }}">
    @endif
  <!-------  End SEO Content --------->
  
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/uploads/general/'.generalSetting()->favicon)}}">
    <link rel="apple-touch-icon" href="{{asset('public/uploads/general/'.generalSetting()->favicon)}}">
	<link rel="apple-touch-icon" sizes="72x72" href="{{asset('public/uploads/general/'.generalSetting()->favicon)}}">
	<link rel="apple-touch-icon" sizes="114x114" href="{{asset('public/uploads/general/'.generalSetting()->favicon)}}">
	
	<link href="{{asset('/public/font/Roboto-Regular.ttf')}}">
	<!-- ==============================================
	CSS VENDOR
	=============================================== -->
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/owl.carousel.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/owl.theme.default.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/magnific-popup.css">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/animate.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/')}}/vendor/bootstrap-dropdownhover.min.css">
...
/*			background-color: #890800!important;*/
    ...
    .teamImg{
        ...
        /*    background-image:url({{asset('public/toggler_icon.png')}});*/
        /*}*/
        .certificate{
            width:100%;
            height:350px;
...
<body data-aos-easing="ease-in-out-sine" data-aos-duration="400" data-aos-delay="0">
	...
	<script src="{{asset('public/frontend/js')}}/vendor/owl.carousel.js"></script>
	...
	<script src="{{asset('public/frontend/js')}}/vendor/form-scripts.js"></script>
...
<!------------------------------------------------->
     <a href="tel:{{generalSetting()->phone}}" class="phone"><img src="{{asset('public/common/phone.png')}}" /></a>
    <a href="https://api.whatsapp.com/send?phone={{generalSetting()->whatsapp_number}}" target="blank" class="whatsapp"><img src="{{asset('public/common/whatsapp.png')}}"></a>
    <div class="google_transalate" id="google_translate_element"></div>
    <link rel="stylesheet" href="{{asset('public/common/formsidebar.css')}}">
    <script src="{{asset('public/common/formsidebar.js')}}"></script>
