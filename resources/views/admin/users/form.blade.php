...
<div class="row">
    ...
    <div class="row">
        <div class="col-12">
                <form class="form-horizontal" action="{{ route('admin.users.store')}}" method="post" id="addForm"   enctype="multipart/form-data">
                       @csrf
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" {{ isset($users)?($users->status==1?'selected':''):''}}>Active</option>
                                             <option value="2" {{ isset($users)?($users->status==2?'selected':''):''}}>Pending</option>
                                              <option value="0"{{ isset($users)?($users->status==0?'selected':''):''}}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                @endif
