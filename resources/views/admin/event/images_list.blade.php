...
<!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                      <a href="{{url('admin/event/add/images/'.$event->id)}}" class="btn btn-sm btn-primary btn-rounded width-md waves-effect waves-light float-right"><i class="fa fa-plus"></i> Add Images</a>
