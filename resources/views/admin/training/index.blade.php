    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row mb-2">
                ...
                <div class="col-2">
                    <a href="{{route('admin.training.add')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add {{$delete_title}}</a>
                </div>
            </div>
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                 @foreach($training as $key => $enq)
                    <tr style="width:100%;">
                        <td style="width:10%;">{{++$key}}</td>
                        <td style="width:20%;">{{ substr($enq->title , 0,25)}}</td>
                        <td style="width:20%;">
                            {{ $enq->category?getCategory($enq->category)->title:''}}
                        </td>
                        <td style="width:10%;">
                        ...
                        <td style="width:10%;">
                            <a href="{{url('admin/training/edit/'.$enq->id)}}" class="btn btn-xs bg-primary text-white">
