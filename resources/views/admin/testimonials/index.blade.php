    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row mb-2">
                ...
                <div class="col-2">
                    <a href="{{route('admin.testimonials.add')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add {{$delete_title}}</a>
                </div>
            </div>
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                 @foreach($testimonials as $key => $enq)
                    <tr>
                        <td>{{++$key}}</td>
                        <td>{{$enq->name}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/testimonials/edit/'.$enq->id)}}" class="btn btn-xs bg-primary text-white">
