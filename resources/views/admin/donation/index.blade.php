    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row mb-2">
                ...
                {{-----------
                <div class="col-2">
                    <a href="{{route('admin.donation.add')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add {{$delete_title}}</a>
                </div>
                ------------}}
            </div>
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                 @foreach($donation as $key => $enq)
                    <tr>
                        <td>{{++$key}}</td>
                        <td>{{$enq->title}}</td>
                        <td class="w-25"><img src="{{asset('public/uploads/donation/'.$enq->image)}}" class="w-25 img-responsive"></td>
                        <td>
                       {{$enq->type}}
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="{{url('admin/donation/edit/'.$enq->id)}}" class="btn btn-xs bg-primary text-white">
