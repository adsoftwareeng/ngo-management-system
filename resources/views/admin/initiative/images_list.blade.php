...
<!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                      <a href="{{url('admin/initiative/add/images/'.$initiative->id)}}" class="btn btn-sm btn-primary btn-rounded width-md waves-effect waves-light float-right"><i class="fa fa-plus"></i> Add Images</a>
                                    <h4 class="header-title mb-0 pb-2">{{$page_title}} </h4>
