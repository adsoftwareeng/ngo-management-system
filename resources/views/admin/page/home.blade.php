                            ...
                            @php $description =  json_decode($page->description,true);
                             ...
                             @for($i=1; $i<=4; $i++)
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                       <input class="form-control" placeholder="Enter Counting Number" name="description[number{{$i}}]" value="{{@$description['number'.$i]}}">
                                    </div>
                              ...
                              @endfor
                                ...
                                <label class="col-md-2 col-form-label" for="example-email">PopUp Image</label>
                                    <div class="col-md-6">
                                      ...
                                      <img src="{{asset('public/uploads/page/'.$page->popup)}}" class="w-25 img-responsive">
                                    </div>
