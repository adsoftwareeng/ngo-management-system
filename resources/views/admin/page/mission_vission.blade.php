        ...
        <div class="col-12">
                 <form  action="{{ route('admin.page.store')}}" method="post"    enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="type" value="{{$type}}">
                              ...
                              <div class="form-group row">
                                   <label class="col-md-2 col-form-label" for="example-range">Vission
                                   </label>
                                    <div class="col-md-10">
                                  ...
                                  <div class="form-group row">
                                     <label class="col-md-2 col-form-label" for="example-range">Mission
                                    </label>
                                    <div class="col-md-10">
                                       <textarea class="form-control" style="height:100px" placeholder="Enter " name="description">{{isset($page)?$page->description:old('description')}}</textarea>
                                    </div>
                                </div>
