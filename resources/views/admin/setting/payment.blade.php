					...
					<div class="row">
                        <div class="col-lg-3">
                            <div class="nav flex-column m-3 nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link navLink active" data-toggle="pill" href="#cod">{{ __('Pay Offline') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#stripe">{{ __('Stripe') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#paypal">{{ __('Paypal') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#molly">{{ __('Mollie') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#paytm">{{ __('Paytm') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#phonepe">{{ __('Phone Pe') }}</a>
                                    
                                    <a class="nav-link navLink" data-toggle="pill" href="#razorpay">{{ __('Razorpay') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#sslcommerz">{{ __('SSL commerz') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#mercadopago">{{ __('Mercadopago') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#authorize">{{ __('Authorize.Net') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#paystack">{{ __('Paystack') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#flutterwave">{{ __('Flutterwave') }}</a>
                                    <a class="nav-link navLink" data-toggle="pill" href="#bank">{{ __('Bank Transfer') }}</a>
                                    ...
                                    <div class="container pl-0 pr-0 ml-0 mr-0 w-100 mw-100">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch-primary">
                                                            ...
                                                            <span class="switch-text">{{ __('Display  Pay Offline') }}</span>
                                                        </label>
                                                    </div>
                                                        ...
                                                        <div class="image-show {{ $cod->status == 1 ? '' : 'd-none' }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12 pb-1">
                                                                    <img class="admin-setting-img"
                                                                        src="{{ $cod->photo ? asset('public/uploads/payment/'.$cod->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                        alt="No Image Found">
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="text" id="text" class="form-control summernote" rows="5"
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $stripe->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $stripe->photo ? asset('public/uploads/payment/'.$stripe->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paypal->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paypal->photo ? asset('public/uploads/payment/'.$paypal->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    alt="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $molly->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $molly->photo ? asset('public/uploads/payment/'.$molly->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    alt="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paytm->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paytm->photo ? asset('public/uploads/payment/'.$paytm->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group d-flex justify-content-center">
                                                                <button type="submit" class="btn btn-success btn-block w-50">{{ __('Submit') }}</button>
                                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $sslcommerz->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $sslcommerz->photo ? asset('public/uploads/payment/'.$sslcommerz->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $mercadopago->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $mercadopago->photo ? asset('public/uploads/payment/'.$mercadopago->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $authorize->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $authorize->photo ? asset('public/uploads/payment/'.$authorize->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paystack->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paystack->photo ? asset('public/uploads/payment/'.$paystack->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                          ...
                                          <div id="bank" class="container tab-pane"><br>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $bank->status == 1 ? '' : 'd-none' }}">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $bank->photo ? asset('public/uploads/payment/'.$bank->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                            ...
                                            <!-------------- Phone Pe------------->
                                              <div id="phonepe" class="container tab-pane"><br>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch-primary">
                                                            <input type="checkbox" class="switch switch-bootstrap " name="status" value="1" {{ $phonepe->status == 1 ? 'checked' : '' }}>
                                                            <span class="switch-body"></span>
                                                            <span class="switch-text">{{ __('Display Phone Pe') }}</span>
                                                        </label>
                                                    </div>


                                                    <div class="image-show {{ $phonepe->status == 1 ? '' : 'd-none' }}">

                                                        <div class="form-group col-md-12">
                                                            <label for="name">{{ __('Current Image') }}</label>
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $phonepe->photo ? asset('public/uploads/payment/'.$phonepe->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="name">{{ __('Enter Name') }} *</label>
                                                            <input type="text" class="form-control" name="name" id="name" value="{{$phonepe->name}}">
                                                        </div>

                                                        @foreach($phonepeData as $pkey => $phonepeData)
                                                        @if($pkey == 'check_sandbox')

                                                                <div class="form-group  col-md-12">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" name="pkey[{{ __($pkey) }}]" class="custom-control-input" {{ $phonepeData == 1  ? 'checked' : '' }} id="ssl{{ $pkey }}">
                                                                        <label class="custom-control-label" for="ssl{{ $pkey }}">
                                                                        {{ __( $phonepe->name.' '.ucwords(str_replace('_',' ',$pkey)) ) }}
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            @else
                                                                    <div class="form-group col-md-12">
                                                                        <label for="inp-{{ __($pkey) }}">{{ __( $phonepe->name.' '.ucwords(str_replace('_',' ',$pkey)) ) }}</label>
                                                                        <input type="text" class="form-control" id="inp-{{ __($pkey) }}" name="pkey[{{ __($pkey) }}]"  placeholder="{{ __( $phonepe->name.' '.ucwords(str_replace('_',' ',$pkey)) ) }}" value="{{ $phonepeData }}" required>
                                                                    </div>
                                                            @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="text" id="text" class="form-control " rows="5"
                                                                placeholder="{{ __('Enter Text') }}"
                                                                >{{ $phonepe->text }}</textarea>
                                                        </div>

                                                        <input type="hidden" name="unique_keyword" value="phonepe">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $razorpay->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $razorpay->photo ? asset('public/uploads/payment/'.$razorpay->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $flutterwave->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $flutterwave->photo ? asset('public/uploads/payment/'.$flutterwave->photo) : asset('public/uploads/payment/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
