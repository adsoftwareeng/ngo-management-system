    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row mb-2">
                ...
                <div class="col-2">
                    <a href="{{route('admin.service.add')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add {{$delete_title}}</a>
                </div>
            </div>
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                 @foreach($service as $key => $enq)
                    <tr>
                        <td>{{++$key}}</td>
                        <td>{!! $enq->title !!}</p></td>
                        <td><img src="{{asset('public/uploads/service/'.$enq->image)}}" style="width:100px;height:100px;"></td>
                        <!-- <td>{{getCategory($enq->category)->title?? ''}}</td> -->
                        <!-- <td>{{$enq->no_of_pages}}</td> -->
                        ...
                        <td>
                            <a href="{{url('admin/projects/edit/'.$enq->id)}}" class="btn btn-xs bg-primary text-white">
