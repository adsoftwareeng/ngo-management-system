          ...
          <!---->
             <div class="row">
                    <div class="col-12">
                             ...
                             <form  class="dropzone" action="{{ route('admin.gallery.multistore')}}" method="post"   enctype="multipart/form-data">
                                  @csrf
                               <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="example-range">Album</label>
                                    <div class="col-md-10">
                                      ...
                                      @foreach($album as $albums)
                                            ...
                                            {{ isset($gallery)?($gallery->album_id==$albums->id?'selected':''):''}}>{{$albums->title}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                                 ...
                                 <label class="col-md-2 col-form-label" for="example-range">Type</label>
                                    <div class="col-md-10">
                                        <select class="form-control" name="type">
                                            ...
                                            <option value="image"{{ isset($gallery)?($gallery->type=='image'?'selected':''):''}}>Gallery</option>
                                            <option value="press" {{ isset($gallery)?($gallery->type=='press'?'selected':''):''}}> News</option>
                                        </select>
                                    </div>
                                </div>
