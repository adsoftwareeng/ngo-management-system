    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row mb-2">
                ...
                <div class="col-2">
                    <a href="{{route('admin.category_form.add')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add {{$delete_title}}</a>
                </div>
            </div>
                ...
                <tbody>
                 @foreach($category as $key => $enq)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/category-edit/'.$enq->id)}}" class="btn btn-xs bg-primary text-white">
