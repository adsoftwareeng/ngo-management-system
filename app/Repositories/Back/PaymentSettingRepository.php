...
class PaymentSettingRepository
{
    ...
    public function payment()
    {
        ...
        //phone pe
        $phonepe = PaymentSetting::whereUniqueKeyword('phonepe')->first();
        $data['phonepeData'] = $phonepe->convertJsonData();
    ...
    public function update($request)
    {
        ...
        if ($file = $request->file('photo')) {
            $input['photo'] = ImageHelper::handleUpdatedUploadedImage($file, '/public/uploads/payment', $pay_data, '/public/uploads/payment/', 'photo');
        }
